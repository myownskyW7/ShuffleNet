...
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet18',
                    choices=model_names + ['ShuffleNet'],
...
parser.add_argument('--gpus', type=int, nargs='+', default=[0], help='specify gpu ids to use')
...
def main():
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            checkpoint = torchpack.load_checkpoint(model.module, args.resume)
